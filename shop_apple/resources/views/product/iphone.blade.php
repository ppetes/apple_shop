                    ...
                    <div class="container mx-auto text-center">
                        ...
                        @else
                            ...
                            @foreach($products as $product)
                                    <div class="bg-gray-100 dark:bg-gray-700 p-6 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg transition-transform transform hover:scale-105 flex flex-col justify-between min-h-[400px]">
                                        <!-- Product Photo -->
